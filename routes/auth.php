...
Route::middleware('guest')->group(function () {
    ...
    Route::post('login/etudiant', [\App\Http\Controllers\Auth\EtudiantLoginController::class, 'store'])
        ->name('login.etudiant.store');

    Route::get('login/professeur', [\App\Http\Controllers\Auth\ProfesseurLoginController::class, 'create'])
