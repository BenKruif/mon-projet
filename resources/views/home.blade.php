...
<body class="antialiased">
    ...
    <div class="min-h-screen animated-bg relative overflow-hidden">
        ...
        <nav class="absolute top-0 left-0 right-0 z-50 px-6 py-4">
            <div class="max-w-7xl mx-auto flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    ...
                    @else
                    <a href="{{ route('login.etudiant') }}" class="px-6 py-2.5 text-white/80 hover:text-white font-semibold transition-colors">
                        Étudiant
                    </a>
                    <a href="{{ route('login.professeur') }}" class="px-6 py-2.5 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-semibold rounded-xl hover:from-purple-700 hover:to-indigo-700 transition-all shadow-lg shadow-purple-500/30">
                        Professeur
                    </a>
                    @endauth
                </div>
        ...
        <div class="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 pt-20">
            <div class="text-center mb-12 floating">
                ...
                {{-- Inscription temporairement désactivée --}}
            </div>
    ...
    <section class="py-20 bg-gray-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-black text-white mb-4">Tout ce dont vous avez besoin en un seul endroit</h2>
    ...
    <footer class="bg-gray-900 border-t border-gray-800 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <p class="text-gray-500 text-sm">© 2025 EcoleInfoA - Groupe PIGIER.</p>
            </div>
        </div>
    </footer>
</body>
