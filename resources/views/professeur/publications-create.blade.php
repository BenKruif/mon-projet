        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                <div class="bg-gradient-to-r from-purple-600 to-indigo-600 px-6 py-5">
                    <h3 class="text-xl font-bold text-white">Créer une publication</h3>
                    <p class="text-purple-100 text-sm mt-1">Partagez une information avec les étudiants</p>
                </div>

                <form action="{{ route('professeur.publications.store') }}" method="POST" class="p-6 space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="text" name="titre" id="titre" required value="{{ old('titre') }}"
                            ...
                            placeholder="Ex: Examens de fin de semestre">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                            <label class="relative cursor-pointer">
                                <input type="radio" name="categorie" value="information" class="peer sr-only" {{ old('categorie', 'information') === 'information' ? 'checked' : '' }}>
                            ...
                            <label class="relative cursor-pointer">
                                <input type="radio" name="categorie" value="annonce" class="peer sr-only" {{ old('categorie') === 'annonce' ? 'checked' : '' }}>
                            ...
                            <label class="relative cursor-pointer">
                                <input type="radio" name="categorie" value="evenement" class="peer sr-only" {{ old('categorie') === 'evenement' ? 'checked' : '' }}>
                            ...
                            <label class="relative cursor-pointer">
                                <input type="radio" name="categorie" value="urgent" class="peer sr-only" {{ old('categorie') === 'urgent' ? 'checked' : '' }}>
                    ...
                    <div>
                        ...
                        <textarea name="contenu" id="contenu" rows="6" required 
                            class="w-full rounded-xl border-gray-300 focus:border-purple-500 focus:ring-purple-500" 
                            placeholder="Rédigez votre publication...">{{ old('contenu') }}</textarea>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="p-4 bg-gray-50 rounded-xl">
                            <label class="flex items-center cursor-pointer">
                                <input type="checkbox" name="est_public" value="1" checked 
                        ...
                        <div class="p-4 bg-gray-50 rounded-xl">
                            <label class="flex items-center cursor-pointer">
                                <input type="checkbox" name="est_epingle" value="1"
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="date_expiration" id="date_expiration" 
                            class="w-full rounded-xl border-gray-300 focus:border-purple-500 focus:ring-purple-500">
                        <p class="text-xs text-gray-500 mt-1">La publication sera masquée après cette date</p>
                    </div>
